      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            role="alertdialog"
            aria-live="assertive"
            className="fixed left-1/2 top-1/2 z-[9999] w-[92vw] max-w-md -translate-x-1/2 -translate-y-1/2"
          >
              ...
              <div className="p-6 sm:p-7">
                ...
                <div className="mt-5 flex flex-col gap-2 sm:flex-row">
                  <a
                    ...
                    className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl bg-white px-4 py-3 text-sm font-semibold text-primary transition hover:bg-white/90"
                  >
                  ...
                  <button
                    type="button"
                    onClick={handleCopy}
                    className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/30 px-4 py-3 text-sm font-medium text-primary-foreground transition hover:bg-white/10"
                  >
                    {copied ? (
                      <>
