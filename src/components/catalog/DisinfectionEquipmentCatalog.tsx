...
export function DisinfectionEquipmentCatalog({ onSubcategoryChange }: DisinfectionEquipmentCatalogProps) {
  ...
  const handleProductClick = (product: DisinfectionProduct) => {
    ...
    <div className="space-y-4">
      <AnimatePresence mode="wait">
        {!selectedSubcategory ? (
          ...
          >
            {disinfectionEquipmentData.subcategories.map((subcategory) => (
              <button
                key={subcategory.id}
