...
Комплект P40 ATEX с аксессуарами c маркировкой взрывозащиты III Dc c IIIC T 125ºC Х предназначена для специальной очистки систем вентиляции во взрывоопасных зонах. Область применения - взрывоопасные зоны помещений и наружных установок в соответствии с присвоенной маркировкой взрывозащиты, требованиями ГОСТ IEC 60079-14-2011 и ГОСТ 31438.1-2011 (EN 1127-1:2007) отраслевых Правил безопасности, регламентирующих применение данного оборудования во взрывоопасных зонах.`,
          features: [
            'Маркировка III Dc c IIIC T 125ºC Х',
            'Соответствует ГОСТ IEC 60079-14-2011',
            'Соответствует ГОСТ 31438.1-2011',
            'Для взрывоопасных зон'
          ],
          specifications: {
            'Маркировка': 'III Dc c IIIC T 125ºC Х',
            'Производитель': 'Pressovac Oy',
            'Страна': 'Финляндия',
            'Вес': '210,00 кг'
          },
          image: p40AtexImage
