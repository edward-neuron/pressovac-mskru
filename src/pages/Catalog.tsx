...
import vacuumEquipmentMain11 from '@/assets/vacuum-equipment-main-1-1.webp';
import vacuumEquipment31 from '@/assets/vacuum-equipment-3-1.webp';
import filterEquipmentSquare from '@/assets/filter-equipment-square.webp';
import disinfectionSquareV2 from '@/assets/disinfection-square-v2.webp';
import disinfectionBannerV2 from '@/assets/disinfection-banner-v2.webp';
import videoInspectionSquareV2 from '@/assets/video-inspection-square-v2.webp';
import videoInspectionBannerV2 from '@/assets/video-inspection-banner-v2.webp';
...
import catalogHeroBanner from '@/assets/catalog-hero-banner.webp';
// SEO data
...
const categories: Category[] = [
  ...
  },
  {
    ...
    description: 'Инспекционное оборудование Pressovac полезно как для того, чтобы заинтересовать клиента (показав ему, как выглядит изнутри его воздуховод), так и для того, чтобы после очистки подтвердить, что воздуховод, очищенный довольно затратным способом, действительно чист, и не поврежден.',
    hasDetailedCatalog: true,
