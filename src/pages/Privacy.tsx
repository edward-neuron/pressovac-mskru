      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <ul className="list-disc pl-6 text-muted-foreground space-y-3 mb-6">
            ...
            <li><strong>Веб-сайт</strong> – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://pressovac-msk.ru (далее – сайт, веб-сайт). Почта сайта (оператора) – sales@pressovac-msk.ru.</li>
